      ...
      <div className="relative h-[60vh] w-full overflow-hidden flex items-center justify-center mb-16">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <p className="mt-6 text-gray-300 max-w-2xl mx-auto font-light leading-relaxed">
            A legacy of culinary excellence and Italian tradition.
          </p>
        </div>
      </div>
      <div
        ref={containerRef}
        className="max-w-7xl mx-auto px-4 md:px-8 min-h-screen flex flex-col md:flex-row items-center gap-16 relative overflow-hidden"
      >
        {/* Image Section */}
        ...
        <div ref={textRef} className="w-full md:w-1/2 md:pl-12 z-20">
          <span className="text-paradiso-gold text-sm tracking-widest uppercase block mb-4">
            Our Story
          </span>
          <h2 className="text-5xl md:text-6xl font-serif text-white mb-8 leading-tight">
            Tradition meets <br />{" "}
            <span className="italic text-gray-500">Innovation</span>
          </h2>
          ...
          <div className="flex gap-12 border-t border-white/10 pt-8 mt-12">
            {ABOUT_CONTENT.stats.map((stat, index) => (
              <div key={index}>
                <span className="block text-3xl font-serif text-white mb-2">
                  {stat.value}
                </span>
                <span className="text-xs text-paradiso-gold uppercase tracking-wider">
                  {stat.label}
                </span>
              </div>
            ))}
